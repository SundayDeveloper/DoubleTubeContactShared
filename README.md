# DoubleTubeContact
円弧上の二重管の隙間に詰められた膜を引き抜く、有限滑り接触を用いた非線形動解析問題。

# 解析条件
円弧上の二重管の下側には、結合接触でリング状の足が取りつけられている。同二重管の上側は開放されている。二重管の間には隙間を埋める形で膜が挟まれており、管と膜の接触面には有限滑り接触が設定されている。二重管の足の裏は完全固定となっている。
...
図3 正面から見た二重管(上側開放の水色部分は二重管に挟まれた膜)
</p>
